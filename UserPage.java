...
public class UserPage 
{
	...
	public void verifyaddtab() throws IOException, InterruptedException
	{
		...
		Assert.assertEquals("AtoZ Grocery | Wholesaler in Bangalore", title);
		
		String pagesource = driver.getPageSource();
		if(pagesource.contains(p.getProperty("tabname")))
		{
			System.out.println("The presence of newly added tab name is confirmed on User page!");
	...
	public void verifyedittab() throws IOException, InterruptedException
	{
		...
		{
			System.out.println("The presence of edited tab name is confirmed on User page!");
			Assert.assertTrue(true);
		}
		else {
			System.out.println("The tab name doesn't exist on User page");
	...
	//WebElement for Customer name on My Order
		...
		public void verifycategory() throws IOException, InterruptedException
		{
			...
			driver.findElement(By.xpath("(//span[@class='click-categories flaticon-bars'])[2]")).click();
						
			String pagesource = driver.getPageSource();
			if(pagesource.contains(p.getProperty("catname")))
			{
				System.out.println("The presence of edited Category name is confirmed on User page!");
				Assert.assertTrue(true);
			}
			else {
				System.out.println("The tab name doesn't exist on User page");
